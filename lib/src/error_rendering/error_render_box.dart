...
/// [LoggingRenderErrorBox.backgroundColor] static property.
///
...
/// [LoggingRenderErrorBox.textStyle] and [LoggingRenderErrorBox.paragraphStyle] static
/// properties.
///
...
class LoggingRenderErrorBox extends RenderBox {
  ...
  LoggingRenderErrorBox([this.message = '', this.flutterError]) {
    try {
      if (message != '') {
  ...
  ///
  /// This is intended to ensure that if the [LoggingRenderErrorBox] is placed at the top left
  ...
  /// The color to use when painting the background of [LoggingRenderErrorBox] objects.
  ///
  ...
  /// The text style to use when painting [LoggingRenderErrorBox] objects.
  ///
  ...
  /// The paragraph style to use when painting [LoggingRenderErrorBox] objects.
