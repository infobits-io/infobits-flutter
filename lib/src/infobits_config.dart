  ...
  static Future<void> initialize({
    ...
    if (effectiveDomain == null && apiKey != null) {
      try {
        ...
        throw ArgumentError('Could not automatically determine domain/namespace from package. Please provide either domain or namespace parameter.');
      }
    }
    ...
    _instance = InfobitsConfig._(
      ...
      analyticsIngestUrl: analyticsIngestUrl ?? RegionConfig.defaultAnalyticsIngestUrl,
      loggingIngestUrl: loggingIngestUrl ?? RegionConfig.defaultLoggingIngestUrl,
      onLog: onLog,
